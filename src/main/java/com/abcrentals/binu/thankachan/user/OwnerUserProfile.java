...
/*
 * OwnerUser class for form backing when entering OwnerUser data
 * 
 * 
 * 
 */
...
public class OwnerUserProfile {
	...
	public String toString() {
		return "OwnerUserProfile [contactInfoId=" + contactInfoId + ", contactInfoFirstName="
