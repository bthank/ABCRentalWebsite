...
/*
 * ManagerUser class for form backing when entering ManagerUser data
 * 
 * 
 * 
 */
...
@Entity
@Table(name="manager_user_profile")
public class ManagerUserProfile {
	...
	public String toString() {
		return "ManagerUserProfile [contactInfoId=" + contactInfoId + ", contactInfoFirstName="
