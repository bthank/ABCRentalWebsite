...
<html lang="en">
<head>
<title>ABC Rental Property Management - Display Employee
	Profile</title>
<meta charset="utf-8">
						...
						<div class="col-12 col-lg-9 col-xl-7">
							<div class="card">
								<div class="card-body p-4 p-md-5">
									<h3 class="mb-4 pb-2">Display Employee Profile</h3>
									...
									<form:form action="" modelAttribute="employeeUserProfile" >
