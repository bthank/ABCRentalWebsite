...
<html lang="en">
<head>
<title>ABC Rental Property Management - Maintenance - Select User To Update Access For</title>
<meta charset="utf-8">
						...
						<div class="col-12 col-lg-9 col-xl-7">
							<div class="card">
								<div class="card-body p-4 p-md-5">
									<h3 class="mb-4 pb-2">Select User To Update Access For</h3>
									...
									<form:form
										action="${pageContext.request.contextPath}/maintenance/manage-users/showUserToUpdateAccessForForm"
										...
										<div class="row">
											...
											<div class="col-md-6 mb-4">
												<div class="form-outline">
													...
													<form:label class="form-label" path="id">User</form:label>
													<br>
													<form:select path="id">
														<form:option value="0">-- Select User --</form:option>
														<c:if test="${not empty users}">
															<form:options items="${users}"
																itemValue="id" itemLabel="firstAndLastName" />
														</c:if>
													</form:select>
													<br>
