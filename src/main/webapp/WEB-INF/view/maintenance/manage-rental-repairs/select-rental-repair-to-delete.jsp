...
<html lang="en">
<head>
<title>ABC Rental Property Management - Select Rental Repair To Delete</title>
<meta charset="utf-8">
						...
						<div class="col-12 col-lg-9 col-xl-7">
							<div class="card">
								<div class="card-body p-4 p-md-5">
									<h3 class="mb-4 pb-2">Select Rental Repair to Delete</h3>
									...
									<form:form
										action="${pageContext.request.contextPath}/maintenance/manage-rental-repairs/processDeleteRentalRepairForm"
												...
												<div class="form-outline">
													...
													<form:select path="id">
														...
														<c:if test="${not empty rentalRepairList}">
															<form:options items="${rentalRepairList}"
