...
<body>
	...
	<div class="container" style="margin-top: 30px">
		<div class="row">
			<div class="col-sm-4">
				<h2>Manager's Training</h2>
				<h5>September 18-19, 2021</h5>
				<div class="box box1">
					<img alt="beach image"
				...
				<p>
			See you all at the next Manager's training weekend on September
			18-19, 2021 in Hilton Head, SC! <br><br> Don't forget to RSVP by
			July 30th.
			...
			<div class="col-sm-8">
				...
				<p>Situated in the heart of the Main Line, Willow Woods boasts
					...
					<br><br>
					<span style="color: red; font-weight: bold;">Managers needed. If you know of someone who would be interested, let us know.</span>
