...
<html lang="en">
<head>
<title>ABC Rental Property Management - Add Manager Profile</title>
<meta charset="utf-8">
						...
						<div class="col-12 col-lg-9 col-xl-7">
							<div class="card">
								<div class="card-body p-4 p-md-5">
									<h3 class="mb-4 pb-2">Add Manager Profile</h3>
									...
									<form:form action="${pageContext.request.contextPath}/manager/processAddManagerProfileForm" modelAttribute="managerUserProfile" method="POST">
