...
<html lang="en">
<head>
<title>ABC Rental Property Management - Manage Rental Payments Page</title>
<meta charset="utf-8">
						...
						<div class="col-12 col-lg-9 col-xl-7">
							<div class="card">
								<div class="card-body p-4 p-md-5">
									<h3 class="mb-4 pb-2 prof-heading">Manage Rental Payments</h3>
									...
									<security:authorize access="hasAnyRole('MANAGER','ADMIN','EMPLOYEE')">
										...
										<div>
											...
											<a
												...
												<button type="button" class="btn btn-primary btn-size">Add Rental Payment</button>
											</a><br><br> 
