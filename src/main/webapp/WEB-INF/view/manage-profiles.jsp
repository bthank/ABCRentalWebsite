...
<html lang="en">
<head>
<title>ABC Rental Property Management - Manage Profiles Page</title>
<meta charset="utf-8">
...
<body>
  ...
  background-size: cover; background-image: url('https://mdbootstrap.com/img/Photos/new-templates/search-box/img4.jpg');">
						...
						<div class="col-12 col-lg-9 col-xl-7">
							<div class="card">
								<div class="card-body p-4 p-md-5">
									<h3 class="mb-4 pb-2 prof-heading">Manage Profiles</h3>
