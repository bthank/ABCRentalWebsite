...
<html lang="en">
<head>
<title>ABC Rental Property Management - Display Renter Profile</title>
<meta charset="utf-8">
						...
						<div class="col-12 col-lg-9 col-xl-7">
							<div class="card">
								<div class="card-body p-4 p-md-5">
									<h3 class="mb-4 pb-2">Display Renter Profile</h3>
									...
									<form:form action="" modelAttribute="renterUserProfile">
										...
										<div class="row">
											...
											<div class="col-md-6 mb-4">
												...
												<div class="form-outline">
													...
													<form:input type="text" path="contactInfoPrimaryEmail"
														class="form-control" value="${gender}"
														 disabled="true"  />
													<form:label class="form-label"
														path="contactInfoPrimaryEmail">Gender</form:label>
													<br>
											...
											<div class="col-md-6 mb-4">
												<div class="form-outline">
													...
													<form:input type="text" path="privateInfoEthnicity"
														class="form-control" value="${ethnicity}"
														 disabled="true"  />
													<form:label class="form-label"
														path="privateInfoEthnicity">Ethnicity</form:label>
													<br>
										...
										<div class="row">
											<div class="col-md-6 mb-4">
												...
												<div class="form-outline">
													...
													<form:input type="number" path="privateInfoSsn"
														...
														value="${privateInfo.ssn}" disabled="true"  />
											...
											<div class="col-md-6 mb-4">
												<div class="form-outline"></div>
													...
													<form:input type="text" path="privateInfoDob"
														class="form-control" maxlength="9"
														value="${privateInfo.dob}" disabled="true" />
										...
										<div class="row">
											...
											<div class="col-md-6 mb-4">
												...
												<div class="form-outline">
													...
													<form:input type="number" path="privateInfoCreditCardNo"
														...
														value="${privateInfo.creditCardNo}"  disabled="true"  />
													<form:label class="form-label"
											...
											<div class="col-md-6 mb-4">
												<div class="form-outline">
													...
													<form:input type="text" path="privateInfoCreditCardNoExpMonth" 
														class="form-control" value="${ccExpMonth}"
														 disabled="true"  />
													<form:label class="form-label" path="privateInfoCreditCardNoExpMonth"
														 >CC Exp Month</form:label>
													<br>
										...
										<div class="row">
											...
											<div class="col-md-6 mb-4">
												...
												<div class="form-outline">
													...
													<form:input type="number" path="privateInfoCreditCardNoCCVCode"  
														class="form-control" value="${privateInfo.creditCardNoExpYear}"
														 disabled="true"  />
													<form:label path="privateInfoCreditCardNoCCVCode" class="form-label"
														 >CC Exp Month</form:label>
													<br>
												...
												<div class="col-md-6 mb-4">
													<div class="form-outline">
														<form:input type="text" path="privateInfoCCBillingCity"
															class="form-control" maxlength="50"
															value="${creditCardBillingAddress.city}"  disabled="true"  />
														<form:label class="form-label"
											...
											<div class="row">
												...
												<div class="col-md-6 mb-4">
													<div class="form-outline">
														...
														<form:input type="text" path="privateInfoCCBillingState"
															class="form-control" maxlength="50"
															value="${creditCardBillingAddress.state}"  disabled="true"  />
														<form:label class="form-label"
															path="privateInfoCCBillingState">State</form:label>
											...
											<div class="row">
												...
												<div class="col-md-6 mb-4">
													<div class="form-outline">
														...
														<form:input type="text" path="privateInfoCCBillingCountry"
															class="form-control" maxlength="50"
															value="${creditCardBillingAddress.country}"  disabled="true"  />
														<form:label class="form-label"
